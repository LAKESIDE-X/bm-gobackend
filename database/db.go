...
func ConnectDB() {
	...
	err = db.AutoMigrate(&models.User{}, &models.Product{}, &models.CartItem{}, &models.Order{}, &models.OrderItem{}, &models.Review{}, &models.OTP{}, &models.Brand{}, &models.Category{}, &models.Product{}, &models.Wishlist{}, &models.Review{})
	if err != nil {
